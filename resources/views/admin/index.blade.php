				...
				<div class="col-xl-2 col-6">
					<div class="box overflow-hidden pull-up">
						<div class="box-body">							
							...
							<div>
								<p class="text-mute mt-20 mb-0 font-size-16">New</p>
				...
				<div class="col-xl-2 col-6">
					<div class="box overflow-hidden pull-up">
						<div class="box-body">							
							...
							<div>
								<p class="text-mute mt-20 mb-0 font-size-16">In Call</p>
				...
				<div class="col-xl-2 col-6">
					<div class="box overflow-hidden pull-up">
						<div class="box-body">							
							...
							<div>
								<p class="text-mute mt-20 mb-0 font-size-16">Out Call</p>
				...
				<div class="col-xl-2 col-6">
					<div class="box overflow-hidden pull-up">
						<div class="box-body">							
							...
							<div>
								<p class="text-mute mt-20 mb-0 font-size-16">Total </p>
